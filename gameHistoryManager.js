...
const GameHistoryManager = {
     ...
     */
    async loadHistory() {
        0 && console.log('[GameHistoryManager] Cargando historial...');

        if (!PlayerDataManager.currentPlayer || !PlayerDataManager.currentPlayer.auth_id) {
            0 && console.warn('[GameHistoryManager] No autenticado');
            return [];
        }
        ...
        try {
            ...
            0 && console.log(`[GameHistoryManager] Cargadas ${this.games.length} partidas`);
            return this.games;
     ...
     */
    open: async function() {
        0 && console.log('[GameHistoryManager] Abriendo historial...');
    ...
    async openGameLegacy(gameIndex) {
        ...
        0 && console.log('[GameHistoryManager] Abriendo crónica para:', game.matchId);
    ...
    async shareReplay(gameIndex) {
        ...
        0 && console.log('[GameHistoryManager] Compartiendo replay:', game.matchId);
        ...
        if (typeof ReplayStorage !== 'undefined') {
            ...
            if (token) {
                ...
                0 && console.log('[GameHistoryManager] Enlace de compartición:', shareUrl);
                return shareUrl;
            }
        }
    },
    ...
    async deleteGame(gameIndex) {
        ...
        0 && console.log('[GameHistoryManager] Eliminando partida:', game.matchId);
