...
if (typeof GAME_DATA_REGISTRY !== 'undefined') {
    ...
    0 && console.log(`TUTORIAL_MAP_DATA registrado en GAME_DATA_REGISTRY.maps con clave "${TUTORIAL_MAP_DATA.mapId}"`);
    GAME_DATA_REGISTRY.scenarios[TUTORIAL_SCENARIO_DATA.scenarioId] = TUTORIAL_SCENARIO_DATA;
    0 && console.log(`TUTORIAL_SCENARIO_DATA registrado en GAME_DATA_REGISTRY.scenarios con clave "${TUTORIAL_SCENARIO_DATA.scenarioId}"`);
} else {
