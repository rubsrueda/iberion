// techScreenUI.js
0 && console.log("techScreenUI.js CARGADO (Versión corregida con DOMContentLoaded)");
...
function openTechTreeScreen() {
 ...
 0 && console.log("--- LOG ESTADO --- techScreenUI.js -> openTechTreeScreen INICIO: researchedTechnologies =", JSON.parse(JSON.stringify(gameState?.playerResources?.[1]?.researchedTechnologies || [])));
    ...
    // 1. CREAR Y POSICIONAR TODOS LOS NODOS TECNOLÓGICOS (VUELVE A LA NORMALIDAD)
        for (const techId in TECHNOLOGY_TREE_DATA) {
            ...
            nodeDiv.addEventListener('click', function(event) {
                ...
                0 && console.log(`Clic detectado en el nodo. Abriendo modal para: ${techIdToOpen}`);
...
window.openTechTreeScreen = openTechTreeScreen;
    ...
    function closeTechTreeScreen() {
        ...
        0 && console.log("[TechTree] Pantalla del árbol de tecnologías cerrada.");
        0 && console.log("--- LOG ESTADO --- techScreenUI.js -> closeTechTreeScreen FIN: researchedTechnologies =", JSON.parse(JSON.stringify(gameState?.playerResources?.[1]?.researchedTechnologies || [])));
    }
...
function RequestResearchTech(techId) {
    ...
    function openTechDetailModal(techId) {
        ...
        0 && console.log("Referencia al elemento del modal:", modal);
        ...
        // --- 3. Mostrar el modal ---
        0 && console.log("Intentando mostrar el modal de detalle. Elemento:", modal);
        modal.style.display = 'flex';
        0 && console.log("Estilo 'display' cambiado a 'flex'. El modal debería estar visible.");
    }
...
0 && console.log("✅ techScreenUI.js: Todas las funciones exportadas correctamente");
0 && console.log("   - openTechTreeScreen:", typeof window.openTechTreeScreen);
0 && console.log("   - closeTechTreeScreen:", typeof window.closeTechTreeScreen);
0 && console.log("   - _executeResearch:", typeof window._executeResearch);
0 && console.log("   - refreshTechTreeContent:", typeof window.refreshTechTreeContent);
0 && console.log("   - openTechDetailModal:", typeof window.openTechDetailModal);